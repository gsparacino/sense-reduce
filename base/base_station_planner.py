...
from base.base_adaptation_actions import update_node_configuration, update_last_adaptation_dt
...
class PortfolioBaseStationPlanner(BaseStationPlanner):
    ...
    def plan(
        ...
        if best_configuration is not None and not best_configuration.is_active(node):
            ...
            adaptation_actions.append(update_node_configuration(node.node_id, best_configuration))
    ...
    def fail_safe_plan(self, dt: datetime.datetime, node: NodeManager):
        ...
        adaptation_actions.append(update_last_adaptation_dt(node.node_id))
        self.executor.execute(dt, adaptation_actions)
