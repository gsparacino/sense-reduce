...
class ClusterKnowledge:
    ...
    def __init__(self,
                 ...
                 cluster_adaptation_goals: list[ClusterAdaptationGoal],
                 sensor_adaptation_goals: list[SensorAdaptationGoal],
                 ):
        self.base_station_id = base_station_id
        self.model_manager = model_manager
        self.cluster_adaptation_goals = cluster_adaptation_goals
    ...
    def add_node(self,
        ...
        if node_id not in self._active_nodes:
            if node_id not in self._inactive_nodes:
                ...
                node_manager.next_adaptation_dt = min(
                    goal.get_next_adaptation_dt(node_manager.last_adaptation_dt, node_manager) for goal in
                    self.cluster_adaptation_goals
                )
                ...
                node_manager.data.add_measurement_df(node_initial_df)
            ...
            return SensorKnowledgeInitialization(
                ...
                node_initial_df,
                node_manager.next_adaptation_dt
            )
