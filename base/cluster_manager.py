...
from base.cluster_monitor import ClusterMonitor
...
class ClusterManager:
    ...
    def handle_violation(
        ...
        node.data.add_measurement_df(data)
        node.data.add_violation(dt, configuration_id)
    ...
    def add_measurement(
        ...
        node = self.knowledge.get_node(node_id)
        node.data.add_measurement(dt, measurement.to_numpy())
        self.monitor.monitor(dt, node_id)
        return node.to_sensor_knowledge_update()
