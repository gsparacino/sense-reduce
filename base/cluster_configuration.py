...
class ClusterConfiguration:
    ...
    def __init__(self, option_id: str, models: set[Model], next_adaptation_dt: datetime.datetime):
        self.option_id = option_id
        self.models = models
        self.next_adaptation_dt = next_adaptation_dt
    ...
    def apply(self, dt: datetime.datetime, node: NodeManager) -> None:
        ...
        node.next_adaptation_dt = self.next_adaptation_dt
