...
class BaseStationGateway:
    ...
    def register_node(self, node_id: str, threshold_metric: ThresholdMetric) -> requests.Response:
    ...
    def send_violation(self,
        ...
        try:
            ...
            if model_metadata is not None:
                ...
                model = self.fetch_model(node_id, model_metadata)
    ...
    def fetch_model(self, node_id: str, model_metadata: ModelMetadata) -> LiteModel:
        ...
        """
        try:
            r = requests.get(f'{self.base_address}/models/{node_id}')
    ...
    def fetch_model_and_data(self, node_id: str, threshold_metric: ThresholdMetric) -> (LiteModel, DataStorage):
        ...
        try:
            ...
            response = self.register_node(node_id, threshold_metric)
            body = response.json()
            ...
            model = self.fetch_model(node_id, metadata)
    ...
    def send_measurement(self, node_id: str, dt: datetime.datetime, measurement: np.ndarray):
